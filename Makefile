...
OBJ_C		:= $(patsubst %.c,$(BUILD_BASE)/%.o,$(SRC_C))
OBJ_CPP		:= $(patsubst %.cpp,$(BUILD_BASE)/%.o,$(SRC_CPP))
OBJ			:= $(OBJ_C) $(OBJ_CPP)
...
#	$(ESPTOOL) --baud 921600 --port $(ESPPORT) write_flash $(FW_FILE_1_ADDR) $(FW_FILE_1) $(FW_FILE_2_ADDR) $(FW_FILE_2)
	$(ESPTOOL) --baud 57600 --port $(ESPPORT) write_flash $(FW_FILE_1_ADDR) $(FW_FILE_1) $(FW_FILE_2_ADDR) $(FW_FILE_2)

run:
	$(ESPTOOL) --baud 57600 --port $(ESPPORT) run
